...
version: 1.0.0
description: "Fetches current weather data from OpenWeatherMap API using API key REDACTED-OPENWEATHERMAP-API-KEY. Use for any weather query."
author: sfarrant
...
```
https://api.openweathermap.org/data/2.5/weather?q={CITY}&appid=REDACTED-OPENWEATHERMAP-API-KEY&units=metric
```
...
```
GET https://api.openweathermap.org/data/2.5/weather?q=London&appid=REDACTED-OPENWEATHERMAP-API-KEY&units=metric
```

## API Key

`REDACTED-OPENWEATHERMAP-API-KEY` — stored in Hermes memory and MDB.